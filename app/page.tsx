...
export default function HomePage() {
  return (
    <div style={{ overflow: 'hidden' }}>
      {/* Hero Section com SUA IMAGEM EM AQUARELA */}
      <div 
        ...
        style={{
          ...
          height: '100vh',
          minHeight: '600px',
          backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(/images/mulher-aquarela-blog.png)', // SUA IMAGEM AQUARELA
        ...
        <div style={{ maxWidth: '800px', padding: '20px' }}>
          <h1 
            ...
            style={{
              ...
              lineHeight: '1.2',
              marginBottom: '1rem',
              textShadow: '2px 2px 4px rgba(0,0,0,0.8)' // Melhor legibilidade
            }}
          >
          ...
          <p 
            ...
            style={{
              ...
              fontSize: '1.5rem',
              marginBottom: '2rem',
              textShadow: '1px 1px 2px rgba(0,0,0,0.8)' // Melhor legibilidade
            }}
          >
      ...
      <div style={{ backgroundColor: '#f8f9fa', padding: '4rem 0', margin: 0, textAlign: 'center' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1rem' }}>
          <h2 style={{ fontSize: '2.5rem', fontWeight: 'bold', marginBottom: '1rem', color: '#343A40' }}>
            Benefícios do Desafio Vitalidade
          </h2>
          <p style={{ fontSize: '1.25rem', marginBottom: '3rem', color: '#6C757D', maxWidth: '800px', margin: '0 auto 3rem auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(500px, 1fr))', gap: '2rem', marginTop: '3rem' }}>
            {/* Benefício 1 */}
            <div style={{ backgroundColor: 'white', borderRadius: '0.75rem', padding: '2rem', textAlign: 'left', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.05)', border: '1px solid #f0f0f0', borderTop: '4px solid #2E8B57' }}>
              <h3 style={{ fontSize: '1.75rem', fontWeight: '600', marginBottom: '1rem', color: '#343A40' }}>
